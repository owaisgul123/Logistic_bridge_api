...
$parent_id = $_POST["row_id"] ?? null;

// Handle passport scan upload
$passport_scan = $_POST['hidden_passport_scan'];
...
$national_id_scan = $_POST['hidden_national_id_scan'];
...
// driver_license
$driver_license = $_POST['hidden_driver_license'];
...
$group_insurance_scan = $_POST['hidden_group_ins'];
...
// secuarity clearence
$security_clearance_scan = $_POST['hidden_sec_clearence'];   
...
$stmt = $db->prepare("UPDATE drivers SET 
    `name` = ?, 
    employee_number = ?, 
    blood_group = ?,
    passport_number = ?,
